...
class BaseMySQLContainerTest {
  ...
  @NotNull HttpHeaders getHttpHeadersWithToken() {
    AuthenticationRequest authenticationRequest = new AuthenticationRequest();
    authenticationRequest.setEmail("oguzzeyveli@gmail.com");
    authenticationRequest.setPassword("password");
    ResponseEntity<AuthenticationResponse> authResponseEntity =
            testRestTemplate.postForEntity(
                    "/v1/authentication/authenticate", authenticationRequest, AuthenticationResponse.class);
    AuthenticationResponse authenticationResponse = authResponseEntity.getBody();
